...
namespace FrostySdk.Frostbite.PluginInterfaces
{
    public class AssetLoaderHelpers
    {
        ...
        {
            if (assetEntry == null)
                throw new ArgumentNullException(nameof(assetEntry));
...
#if DEBUG
            if (assetEntry.Id.ToString() == "bb78c273-1bec-eb61-5e4b-6a1390e564e9"
                        )
            {
...
//        public static T ConvertDbObjectToAssetEntry<T>(DbObject item, bool useByteSha1 = true)
//        {
//            AssetEntry assetEntry = null;
//            if(typeof(T) == typeof(EbxAssetEntry))
//            {
//                assetEntry = new EbxAssetEntry();
//            }
//            else if (typeof(T) == typeof(ResAssetEntry))
//            {
//                assetEntry = new ResAssetEntry();
//            }
//            else if (typeof(T) == typeof(ChunkAssetEntry))
//            {
//                assetEntry = new ChunkAssetEntry();
//            }
