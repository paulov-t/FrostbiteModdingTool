...
namespace Madden24Plugin.Meshes
{
    internal class Madden24MeshReader : IMeshSetReader
    {
        private Madden24SkinnedMeshReader SkinnedMeshReader { get; } = new Madden24SkinnedMeshReader();
        private Madden24CompositeMeshReader CompositeMeshReader { get; } = new Madden24CompositeMeshReader();
        private Madden24RigidMeshReader RigidMeshReader { get; } = new Madden24RigidMeshReader();
        ...
        public void Read(NativeReader nativeReader, MeshSet meshSet)
        {
            ...
            //meshSet.Madden24_Type2 = (MeshType)nativeReader.ReadByte();
            //meshSet.Madden24_TypeUnknownBytes = nativeReader.ReadBytes(18);
            ...
            //    meshSet.Madden24_SkinnedUnknownBytes = nativeReader.ReadBytes(12);
