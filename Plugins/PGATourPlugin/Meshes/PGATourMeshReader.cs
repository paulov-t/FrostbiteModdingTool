...
{
    internal class PGATourMeshReader : IMeshSetReader
    {
        private PGATourSkinnedMeshReader SkinnedMeshReader { get; } = new PGATourSkinnedMeshReader();
        private PGATourCompositeMeshReader CompositeMeshReader { get; } = new PGATourCompositeMeshReader();
        private PGATourRigidMeshReader RigidMeshReader { get; } = new PGATourRigidMeshReader();
