...
{
    internal class SWSMeshReader : IMeshSetReader
    {
        private SWSSkinnedMeshReader SkinnedMeshReader { get; } = new SWSSkinnedMeshReader();
        private SWSCompositeMeshReader CompositeMeshReader { get; } = new SWSCompositeMeshReader();
        private SWSRigidMeshReader RigidMeshReader { get; } = new SWSRigidMeshReader();
        ...
        public void Read(NativeReader nativeReader, MeshSet meshSet)
        {
            ...
            meshSet.FullName = nativeReader.ReadNullTerminatedString(offset: nativeReader.ReadLong());
            //long offsetNameShort = nativeReader.ReadLong();
            meshSet.Name = nativeReader.ReadNullTerminatedString(offset: nativeReader.ReadLong());
